...
@Composable
fun GenderCardBoy(isSelected: Boolean, onClick: () -> Unit) {
    OutlinedCard(
        modifier = Modifier
            .size(width = 130.dp, height = 180.dp)
            .border(if (isSelected) 2.dp else 2.dp, if (isSelected) Color.Blue else Color.Gray, shape = RoundedCornerShape(12.dp))
            .clickable { onClick() },
        ...
        Column(
            ...
            Image(
                painterResource(R.drawable.malesymbol),
